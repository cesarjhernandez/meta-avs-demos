DESCRIPTION = "Amazon Voice Services Image with QT5 support"
LICENSE = "MIT"

require recipes-avs/images/avs-image.bb
...
IMAGE_LINK_NAME = "${MACHINE}-${IMAGE_BASENAME}-${SOUNDCARD}-v${SDKVERSION}"
